...
np_test_X, np_test_T, np_test_yf, np_test_ycf, n_treated, n_total = \
    dL.load_train_test_ihdp_random(csv_path,
                                    split_size=0.8)
...
means_X = np.empty((150, 5))
means_yf = np.empty((150, 1))
means_ycf = np.empty((150, 1))
means_T = np.empty((150, 1))

labels_yf = np.empty((150, 1))
labels_T = np.empty((150, 1))
labels_ycf = np.empty((150, 1))
